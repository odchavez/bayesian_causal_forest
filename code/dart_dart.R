...
std_per = 0.8
set_val = 2
dat = read.csv(paste0("data/caus_sim_1_N=10000_P=1000_noise_percent=",std_per,"_set_",set_val,".csv"))[,1:pred_num]
...
pdf(paste0("images/dart_dart_",std_per,"_p_val_num=",p_val_num,"_pred_num=",pred_num,".pdf"))  
